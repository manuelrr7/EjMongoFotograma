 ...
 * @version  Ajax-MVC2
 */
public class AccionGeneros implements Accion {
	/**
	...
	public boolean ejecutar(HttpServletRequest request,
		...
		if (procesaBD.darGereneros() != null){		
			
		
			
		}else{
			generos.setError("Error al cargar la lista de generos");
		}
		json = new Gson().toJson(procesaBD.darGereneros());
